...
[BlendAnimState](https://ditoland-utplus.gitbook.io/ditoland/api-reference/client/blendanimstate)에 블렌드 애니메이션이 추가 될 때 세팅하는 객체에요. <br>
<br>
## **함수**
...
애니메이션 이벤트를 추가해요. (추가할 이벤트 이름, 블렌딩 시간, 연결 함수) <br>
<br>
