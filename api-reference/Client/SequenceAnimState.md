...
단일 애니메이션을 플레이하는 애니메이션 상태 객체에요. <br>

[SequenceAnimStateSetting](https://ditoland-utplus.gitbook.io/ditoland/api-reference/client/sequenceanimstatesetting)에서 세팅을 설정할 수 있어요. <br>
<br>
## **함수**
