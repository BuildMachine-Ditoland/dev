...
캐릭터의 Stand 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Idle** |
| :--- |

캐릭터의 Idle 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Walk** |
| :--- |

캐릭터의 Walk 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Run** |
| :--- |

캐릭터의 Run 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Jump** |
| :--- |

캐릭터의 Jump 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Fall** |
| :--- |

캐릭터의 Fall 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Land** |
| :--- |

캐릭터의 Land 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Climb** |
| :--- |

캐릭터의 Climb 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Swim** |
| :--- |

캐릭터의 Swim 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Float** |
| :--- |

캐릭터의 Float 애니메이션을 설정 할 수 있어요. <br>
<br>
| **string Sit** |
| :--- |

캐릭터의 Sit 애니메이션을 설정 할 수 있어요. <br>
<br>
## **함수**
