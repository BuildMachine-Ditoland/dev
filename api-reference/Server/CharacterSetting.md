...
게임에서 사용 될 캐릭터를 설정 할 때 사용되는 객체에요.  <br>

[Game:AddCharacterSetting](https://ditoland-utplus.gitbook.io/ditoland/api-reference/server/game)함수로 추가해요. <br>
<br>
## **속성**
...
캐릭터는 해당 생명만큼 리스폰되요. -1로 설정 시 무한으로 리스폰해요. 디폴트 값은 -1이에요. <br>
<br>
| **float RespawnTime** |
| :--- |
