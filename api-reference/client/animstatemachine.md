...
| **RModeBlendAnimState AddBlendAnimState\(string StateName, protected\_function BlendFunction\)** |
| :--- |
...
| **RModeBlendAnimState AddBlendAnimState\(string StateName, protected\_function BlendFunction, int PlayCount\)** |
| :--- |
...
| **AddTransition\(string FromState, string ToState, protected\_function Condition\)** |
| :--- |
...
| **AddTransition\(string FromState, string ToState, protected\_function Condition, float BlendTime\)** |
| :--- |
