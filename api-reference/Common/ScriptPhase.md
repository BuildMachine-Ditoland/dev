...
Game:AddPhase(단계 이름) 으로 생성할 수 있어요. <br>
...
단계에 진입 시 호출되는 이벤트에요. <br>
<br>
| **UpdateEvent** |
| :--- |

단계가 활성화 되어 있을 때 매 프레임 호출되는 이벤트에요. <br>
<br>
| **ExitEvent** |
| :--- |

단계에서 다른 단계로 변경 될 때 호출되는 이벤트에요. <br>
<br>
## **함수**
...
단계가 활성화 되어 있었던 시간을 얻을 수 있어요. <br>
# **상속받아 사용 가능한 기능들**
